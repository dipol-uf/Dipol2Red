#' @useDynLib Dipol2Red
#' @importFrom vctrs vec_c vec_rbind vec_is_empty vec_cast_common vec_size vec_recycle vec_recycle_common
...
#' @importFrom rlang as_name enquo !! !!! is_null flatten_dbl as_function enquos is_empty is_character syms quo is_missing
